...
/**
 * `asChild` lets a Button render as whatever child it is given — a Next.js
 * `<Link>`, most often — while keeping the button styling. Without it, wrapping a
 * link in a button produces invalid nested-interactive markup that screen readers
 * and browsers both handle badly.
 */
  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        outline: 'border border-input bg-background shadow-soft hover:bg-accent hover:text-accent-foreground active:scale-[0.98]',
