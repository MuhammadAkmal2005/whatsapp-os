...
const contentStyles = cn(
  'z-50 min-w-[9rem] overflow-hidden rounded-lg border border-border bg-popover p-1 text-popover-foreground shadow-overlay',
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      inset && 'pl-8',
      destructive &&
        'text-destructive [&_svg]:text-destructive focus:bg-destructive-surface focus:text-destructive',
      className,
    )}
    {...props}
  />
